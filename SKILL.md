...
description: "用于中文 2B 商业汇报的 PPT 视觉生成与图片页重建工作流：支持整页生图 PPT、图片页 SVG 结构重绘，以及按语义资产拆解并重建为可编辑 PPTX。"
---
...
2. **SVG 结构重绘**：适合用户只要求把图片页拆成可编辑 SVG，或要先做轻量矢量结构样板。
3. **语义可编辑重组**：适合用户给出图片页、截图页或图片型 PPT，并要求将其拆成可编辑 PPTX。
